...
import com.github.standobyte.jojo.command.commands.PillarmanCommand;
...
import com.github.standobyte.jojo.command.commands.SpeciesCommand;
...
public class ModChatCommands {
	...
	public static void registerCommands(RegisterCommandsEvent event) {
		...
		SpeciesCommand.register(dispatcher, context);	// "species"
		PillarmanCommand.register(dispatcher, context);	// "pillarman"
		PlayBgmCommand.register(dispatcher, context);	// "bgm"

		// "stand_skills unlock/unlock_all/reset"
		// "stand_disc give/random"
		// "hamon stat set/add/query"
		// "vampire energy"
		// "pillarman energy"
		// "rock_paper_scissors"
