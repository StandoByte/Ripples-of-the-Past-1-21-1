...
public class TwoHandedBarrageLoopSwing extends BarrageSwing {
	...
	public TwoHandedBarrageLoopSwing(RotpAnimDefinition barrageAnim, LivingEntityRenderState renderState, 
	...
	public static void addSwings(BarrageSwings swings, RotpAnimDefinition barrageAnim, 
			LivingEntityRenderState curRenderState, float animTimeSecs) {
