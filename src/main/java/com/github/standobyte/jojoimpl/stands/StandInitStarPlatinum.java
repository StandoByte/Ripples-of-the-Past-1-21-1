...
//					.addToHotbar("time_stop", 0, InputMethod.HOLD)
				...
				.addSkill(StandUnlockableSkill.unlockableAbility("ground_slam", 100).prerequisiteSkill("heavy_punch"))
				...
				.addSkill(StandUnlockableSkill.unlockableAbility("grab_throw", 150).prerequisiteSkill("grab"))
				.addSkill(StandUnlockableSkill.unlockableAbility("grab_terrain", 200).withAbility("terrain_throw").prerequisiteSkill("grab"))
				.addSkill(StandUnlockableSkill.unlockableAbility("uppercut_ground_throw", 50).prerequisiteSkill("uppercut", "ground_slam"))
				...
				.addSkill(StandUnlockableSkill.unlockableAbility("inhale", 100))
				.addSkill(StandUnlockableSkill.unlockableAbility("time_stop", 2500))
