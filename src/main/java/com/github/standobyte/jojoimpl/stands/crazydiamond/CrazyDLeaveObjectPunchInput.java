...
import com.github.standobyte.jojoimpl.stands._entitybase.StandEntityHeavyPunchChargedAbility.StandEntityChargedHeavy;
...
public class CrazyDLeaveObjectPunchInput extends Ability {
	...
	public Ability replaceWithSubAbility(Power<?> context, AvailableAbilities abilities) {
		...
		if (curAction instanceof StandEntityChargedHeavy punch 
